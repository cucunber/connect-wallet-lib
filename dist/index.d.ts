...
import { INetwork, IProvider, IAddContract, IConnect, ISettings, IConnectorMessage, ContractWeb3, IChain, INoNameContract, IEvent, IEventError, IKeys } from "./interface";
...
export declare class ConnectWallet {
     ...
     */
    use: (wallets: AbstractConstructor[]) => ConnectWallet;
    /**
     ...
     */
    connect(provider: IProvider, network: INetwork, settings?: ISettings, keys?: IKeys): Promise<IConnectorMessage>;
    /**
